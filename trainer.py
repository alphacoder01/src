    ...
    def train(self, epochs=1):
        ...
        for epoch in range(1, epochs + 1):
            ...
            for phase in ['train', 'valid']:
                ...
                train_acc.append(
                    epoch_acc) if phase == 'train' else valid_acc.append(epoch_acc)
                ...
                if phase == 'valid':
                    ...
                    if epoch % 2 == 1:
                        ...
                        torch.save(saved_state, 'saved states/' +
                                   self.saved_state_name + '_epoch_' + str(epoch))
...
def get_confusion_matrix(model_saved_state, dl=None):
    ...
    heatmap = sn.heatmap(df_cm, annot=True, annot_kws={
                         "size": 24}, cmap="Blues", cbar=False, fmt='g')
